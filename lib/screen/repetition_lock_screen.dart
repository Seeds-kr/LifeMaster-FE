...
class RepetitionLockScreen extends StatefulWidget {
  @override
  _RepetitionLockScreenState createState() => _RepetitionLockScreenState();
}

class _RepetitionLockScreenState extends State<RepetitionLockScreen> {
  ...
  bool _isContainerVisible = false; // 컨테이너의 표시 여부를 관리
          ...
          builder: (context, setState) {
            return AlertDialog(
              ...
              content: Container(
                ...
                // height: 377,
                child: Column(
                  mainAxisSize: MainAxisSize.min, // Column이 자식들만큼만 공간을 차지하도록 설정
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text(
                      "반복 잠금 설정",
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          style: TextButton.styleFrom(
                            padding: EdgeInsets.zero, // padding을 0으로 설정하여 높이를 글자 크기와 동일하게 만듦
                            // 배경색 제거
                          ...
                          child: const Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color: Color(0xFFB4D775), // 텍스트 색상 초록색
                            ),
                          ),
                        ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        const Text("사용 시간", style: TextStyle(fontSize: 12)),
                        ...
                        // 시간 텍스트와 컨테이너 사이의 간격을 줄이기 위해 SizedBox 사용
                        SizedBox(width: 8), // 간격을 줄일 수 있음
                        ...
                        // 분 텍스트와 컨테이너 사이의 간격을 줄이기 위해 SizedBox 사용
                        SizedBox(width: 8), // 간격을 줄일 수 있음
                    ...
                    Row(
                      ...
                      children: [
                        const Text("잠금 시간", style: TextStyle(fontSize: 12)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              _isContainerVisible = !_isContainerVisible; // 클릭 시 상태 변경
                            });
                          },
                          child: SvgPicture.asset(
                            _isContainerVisible ? 'assets/icons/minus.svg' : 'assets/icons/plus.svg', // 표시할 아이콘 변경
                            width: 12,
                            height: 12,
                          ),
                        ),
                        ...
                        const Text(" 최대 사용 시간",
                            style: TextStyle(
                              fontSize: 12,
                              color: Color(0xFF8DB83F), // 텍스트 색상 초록색
                            )),

                        SizedBox(width: 12),
                        // Container가 나타날지 말지를 Visibility로 제어
                        Visibility(
                          visible: _isContainerVisible, // _isContainerVisible이 true일 때만 표시
                          child: Row(
                            children: [
                              // 첫 번째 입력 컨테이너
                              Container(
